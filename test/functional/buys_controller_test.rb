...
class BuysControllerTest < ActionController::TestCase
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post :create, buy: { date: @buy.date, price: @buy.price, qty: @buy.qty, status: @buy.status, stock_id: @buy.stock_id }
    end
  ...
  test "should update buy" do
    put :update, id: @buy, buy: { date: @buy.date, price: @buy.price, qty: @buy.qty, status: @buy.status, stock_id: @buy.stock_id }
    assert_redirected_to buy_path(assigns(:buy))
  end
